...
type MainOnboardingScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
...
const MainOnboardingScreen: React.FC<MainOnboardingScreenProps> = ({
  navigation,
}) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.onboardingTitleText}>
        {' '}
      ...
      <View style={styles.progressAndArrowView}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.push('SecondOnboardingScreen')}>
